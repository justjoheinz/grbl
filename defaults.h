...
#define defaults_h
  ...
  // Description: Shapeoko CNC mill with three NEMA 17 1,8 degree stepper motors,
  // driven by 3 TOS-100 shields
  #define MICROSTEPS_XY 8
  ...
  #define DEFAULT_DECIMAL_PLACES 3
  #define DEFAULT_N_ARC_CORRECTION 25
  #define DEFAULT_TRINAMIC_X 1
  #define DEFAULT_TRINAMIC_Y 2
  #define DEFAULT_TRINAMIC_Z 3
  #define NO_SPINDLE_CONTROL
  #define NO_COOLANT_CONTROL
#endif
